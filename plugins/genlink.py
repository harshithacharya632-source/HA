...
from utils import temp# Don't Remove Credit 
import re, os, json, base64, logging
...
async def gen_link_s(bot, message):
    ...
    string += file_id
    outstr = base64.urlsafe_b64encode(string.encode("utf-8")).decode().strip("=")
...
async def gen_link_batch(bot, message):
    ...
    if chat_id in FILE_STORE_CHANNEL:
        ...
        b_64 = base64.urlsafe_b64encode(string.encode("utf-8")).decode().strip("=")

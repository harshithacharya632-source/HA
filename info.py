...
BOT_TOKEN = environ.get('BOT_TOKEN', "7011228023:AAG-cnuOaMMANjuV_hbDv3Ebfexd2RmJEFc")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://www.pinterest.com/i/3FlR6KonZ/')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '762638982').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001545302652').split()]  # For Multiple Id Use One Space Between Each.

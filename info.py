...
auth_channel = environ.get('AUTH_CHANNEL', '-1001887592232 -1002966435914') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002114790010')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003666449199').split()]  # For Multiple Id Use One Space Between Each.
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002966435914'))  # Notification of sent to your channel
...
TMDB_API_KEY = environ.get('TMDB_API_KEY', '85816d9c527e849780eee00c4d368a6c') # preffer to use your own tmdb API Key get it from https://www.themoviedb.org/settings/api
...
MSG_ALRT = environ.get('MSG_ALRT', 'Goflix Team  ❤️')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://continuing-mala-goflixstream-source-d902aa2d.koyeb.app")

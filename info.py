...
TRY_AGAIN_BTN = bool(environ.get('https://trendi_Backup', False)) # Set True Or False (This try again button is only for request to join fsub not for normal fsub)
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003093212211')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://harshithacharya8:Iofufp2aQT3saMJm@cluster0.audaoev.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "harshithacharya8")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Goflix')

MULTIPLE_DATABASE = bool(environ.get('MULTIPLE_DATABASE', True)) # Set True or False

# If Multiple Database Is True Then Fill All Three Below Database Uri Else You Will Get Error.
O_DB_URI = environ.get('O_DB_URI', "mongodb+srv://harshithacharya633:2g91drYh3nV4GDhW@cluster0.3yqvc4p.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db Is For Other Data Store
F_DB_URI = environ.get('F_DB_URI', "mongodb+srv://harshithacharya8:Iofufp2aQT3saMJm@cluster0.audaoev.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "mongodb+srv://harshithacharya633:2g91drYh3nV4GDhW@cluster0.3yqvc4p.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db is for File Data Store When First Db Is Going To Be Full.
...
VERIFY_SHORTLINK_URL = environ.get('VERIFY_SHORTLINK_URL', 'SHORTLINK_URL = https://shrinkme.io/api?api=175a9da92b79af75bf3120f9feee208af8905620&url=')
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'https://shrinkme.io/api?api=175a9da92b79af75bf3120f9feee208af8905620&url=')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/Goflix_AdminBot')

# If You Fill Second Shortner Then Bot Attach Both First And Second Shortner And Use It For Verify.
VERIFY_SECOND_SHORTNER = bool(environ.get('VERIFY_SECOND_SHORTNER', False))
# if verify second shortner is True then fill below url and api
VERIFY_SND_SHORTLINK_URL = environ.get('VERIFY_SND_SHORTLINK_URL', 'yourdestinationlink.com&alias=CustomAlias')
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', '175a9da92b79af75bf3120f9feee208af8905620')


# Shortlink Info
SHORTLINK_MODE = bool(environ.get('SHORTLINK_MODE', False)) # Set True Or False
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'yourdestinationlink.com&alias=CustomAlias')
SHORTLINK_API = environ.get('SHORTLINK_API', '175a9da92b79af75bf3120f9feee208af8905620')

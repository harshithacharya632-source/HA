...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/trendi_Backup/3)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
• /extend_premium - <code>Tᴏ ᴇxᴛᴇɴᴅ ᴀʟʟ ᴘʀᴇᴍɪᴜᴍ ᴜsᴇʀs' ᴇxᴘɪʀʏ ʙʏ ɢɪᴠᴇɴ ᴅᴀʏs. [Usᴀɢᴇ: /extend_premium 7]</code>
• /premium_list - <code>Tᴏ ɢᴇᴛ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴀʟʟ ᴘʀᴇᴍɪᴜᴍ ᴜsᴇʀs.</code>
• /verification - <code>Tᴏ ɢᴇᴛ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴀʟʟ ᴠᴇʀɪғɪᴇᴅ ᴜsᴇʀs.</code>"""
...
⚠️ ᴀᴠᴏɪᴅ ꜱᴘᴇᴄɪᴀʟ ᴄʜᴀʀꜱ ➠ ' : ( ! , . / )
📩 ɴᴏᴛ ꜰᴏᴜɴᴅ ? ᴜꜱᴇ /request ᴛᴏ ʀᴇQᴜᴇꜱᴛ ɪᴛ</b>"""
...
ஏய் <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 படி 1: இந்த GOFLIX BOT போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 Step 1: Administer this GOFLIX BOT bot to your group
...
హే <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 దశ 1: ఈ GOFLIX BOT బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس GOFLIX BOT بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ GOFLIX BOT બોટનું સંચાલન કરો
...
ಹೇ {message.from_user.mention}
 ...
 ಹಂತ 1: ಈ ಫಿಲ್ಟರ್-ಬಾಟ್ ಅನ್ನು ನಿಮ್ಮ ಗುಂಪಿಗೆ ನಿರ್ವಹಿಸಿ
...
আরে <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই GOFLIX BOT বট পরিচালনা করুন
...
✨ <b>{filename}</b>
<a href="{imdb_url}">⭐ ɪᴍᴅʙ</a> · <b>{rating}</b>  |  📅 <b>{year}</b>
